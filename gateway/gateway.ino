...
//      Serial.print(": ");
      Serial.print(arrToStr(data,sizeof(data)));
      Serial.print("..."); 
...
void sendFirebaseData() {
  ...
  String target = deviceName + "/val";
  Serial.print("Sending " + (String) data[1] + " to " + target);
  Serial.print("...");
  unsigned long start_timer = millis();
  if (Firebase.RTDB.setInt(&fbdo, target, data[1])){
